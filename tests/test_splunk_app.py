...
class SplunkAppTests(unittest.TestCase):
    ...
    def test_framework_dependent_selectors_and_defaults_are_safe(self) -> None:
        ...
        self.assertIn("form.requirement_token=$click.value2$", requirements_view)
        ...
        self.assertIn('eval "Open check"=requirement_key', requirements_view)
        self.assertIn('<link>/app/compliance_control_plane/check?form.framework_token=$framework_token$&amp;form.requirement_token=$click.value2$</link>', requirements_view)
